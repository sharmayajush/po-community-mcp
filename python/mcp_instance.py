...
from tools.hr_dispatch_tool import search_available_clinicians
...
mcp.tool(name="SearchAvailableClinicians", description="Searches the hospital HR database for an available clinician matching the required specialty.")(search_available_clinicians)
